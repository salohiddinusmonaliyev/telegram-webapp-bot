try:
    ...
    def main() -> None:
        ...
        application = Application.builder().token("6772972800:AAFdnLexss1mnwesBiOvJFm_VEyQCsHyrYE").build()
    ...
    async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        await update.message.reply_text("Hi! I'm Fastfood delivery bot, I will help you",
    ...
    async def begin(update: Update, context: ContextTypes.DEFAULT_TYPE):
        if update.message.text == "🛍 Buyurtma berish":
            ...
            await update.message.reply_text("Buyurtma berish uchun /start ni bosing",
    ...
    async def get_contact(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text("Yangi buyurtma berish uchun /start ni bosing",
                                        reply_markup=ReplyKeyboardRemove())
        return ConversationHandler.END
    ...
    def main() -> None:
        """Run the bot."""
        # Create the Application and pass it your bot's token.
        application = Application.builder().token("6264932721:AAEzAjVU7N1-puY31rHOSbN3pMJa6OmMFLM").build()
